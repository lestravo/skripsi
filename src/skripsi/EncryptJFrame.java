...
public class EncryptJFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        File encryptedFile = new File(jTextField2.getText()+"/"+inputFile.getName()+".mangkubumi");
        Models model = new Models();
        model.setInputFile(inputFile.toString());
        model.setEncryptedFile(encryptedFile.toString());
        this.setVisible(false);
        EncryptProcessJFrame frame = new EncryptProcessJFrame();
